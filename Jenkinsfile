pipeline {
    ...
    environment {
        DOCKERHUB_CREDENTIALS = credentials('dockerhub') // Replace 'dockerhub' with the ID of your Docker Hub credentials in Jenkins
        DOCKER_IMAGE = 'udhaya21/movie-jenkins' // Replace with your Docker Hub username and image name
        KUBECONFIG = credentials('kubeconfig') // Replace 'kubeconfig' with the ID of your kubeconfig file in Jenkins
    }
